...
{
    public partial class WindowsCardViewModel : BindableObject
    {
        ...
        public WindowsCardViewModel()
        {
            CardQuestions = [];
        }
        public virtual void SetView(WindowsCardView _cv)
        {
            cv = _cv;
        }
        ...
        public Questions CurrentQuestion
        {
            ...
            set
            {
                if (value != CurrentQuestionLocal)
                {

                    CurrentQuestionLocal = value;
                    CurrentIndex = CardQuestions.IndexOf(CurrentQuestionLocal);
        ...
        public async Task ReloadCurrentItem()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Copy database failed ex: " + ex.Message);
            }
        }
    }
}
