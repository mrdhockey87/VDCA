...
public partial class WindowsQuizView : WindowsCardView
{
    ...
    private void CarouselViewLoaded(object sender, EventArgs e)
    {
        MainThread.InvokeOnMainThreadAsync(async () =>
        {
            ...
            {
                if (winqvm.CardQuestions.Count > 0)
                {
                    await winqvm.ReloadCurrentItem();
                }
            }
        });
    }
