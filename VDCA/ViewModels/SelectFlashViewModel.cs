...
public partial class SelectFlashViewModel : SelectViewModel
{    
    //private readonly string LOGTAG = "SelectFlashViewModel";
    public SelectFlashViewModel()
	{
        CategoriesCollection = Constants.CategoriesFlash;
        SelectedCategories = [];
    }
    public override async Task CardsForSelectedSubjects()
    {
        ...
        try
        {
            ...
            await db.GetSelectCategoryFlashcardQuestions(sqlPart);
        ...
        {
            await ShowProgressBarUtil.HideProgressBar(sv.ProgressBarSelectOverlay);
        }
    }
}